  ...
  return (
    <AppShell>
      <div className="flex items-center justify-between mb-3">
        <h1 className="text-xl font-bold text-navy">{t('projectStatus')}</h1>
      ...
      <Card className="mb-3">
        <CardContent className="p-4 space-y-2.5">
          ...
          <div className="flex items-start gap-2 text-sm text-navy"><MapPin className="w-4 h-4 mt-0.5 text-muted-foreground shrink-0" /><span>{data.location}</span></div>
      ...
      <Card className="mb-3" style={{ background: 'rgba(15,174,150,0.08)' }}>
        <CardContent className="p-4">
