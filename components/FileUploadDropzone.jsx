...
export default function FileUploadDropzone({
  ...
  return (
    <label
      className={cn(
        'interactive-card tap-highlight group flex min-h-20 min-w-0 cursor-pointer items-center gap-3 rounded-2xl border-2 border-dashed bg-card px-4 py-3 text-start shadow-soft focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2',
        error
