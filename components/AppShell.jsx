...
export default function AppShell({ children, hideNav = false, hideFooter = false, wide = false, bleed = false }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header
        className={`site-header sticky top-0 z-40 backdrop-blur-md transition-[background-color,box-shadow,border-color] duration-300 ${
          scrolled
      ...
      {!hideNav && (
        <nav className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 safe-pad-bottom max-w-[calc(100vw-20px)] lg:hidden">
          <div className="flex items-center gap-1 bg-white/95 dark:bg-[#0B1624]/95 backdrop-blur-sm rounded-full px-1.5 py-1.5 shadow-lift border border-border">
